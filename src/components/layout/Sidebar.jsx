  ...
  return (
    <>
      ...
      <aside
        ...
        // }`}
        className={`
            w-64 h-screen bg-green-700 
            transform transition-transform duration-300 ease-in-out
            ${isOpen ? "translate-x-0" : "-translate-x-full"}
        `}
        aria-label="Sidenav"
      >
        <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-400">
          <ul className="space-y-2">
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-black hover:bg-[#1F2937] dark:hover:bg-[#22AA86] group hover:text-white"
              >
                <svg
                  aria-hidden="true"
